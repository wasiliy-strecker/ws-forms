...
<div id="wsf_pagination_wrapper" class="wsf_pagination_wrapper">
    ...
    <div class="wsf_pagination_rows_selector">
        <label for="wsf_user_page_selector">Select page</label>
        <select id="wsf_user_page_selector" class="wsf_pagination_select">
            <?php
    ...
    <div class="wsf_pagination_nav">
        ...
        <span class="wsf_pagination_text">
            <?php echo esc_html($startEntry); ?>-<?php echo esc_html($endEntry); ?> of <?php echo esc_html($totalUsers); ?>
        </span>
